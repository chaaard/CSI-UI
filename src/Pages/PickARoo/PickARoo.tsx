...
const PickARoo = () => {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [fetchPickARoo, fetchPickARooMatch, selectedDate, successRefresh]);
  ...
  return (
    ...
    >
      <Grid container spacing={1} alignItems="flex-start" direction={'row'}>
        <Grid item>
          <HeaderButtons handleOpenSubmit={handleOpenSubmit} handleChangeSearch={handleChangeSearch} handleOpenModal={handleOpenModal} handleOpenRefresh={handleOpenRefresh} customerName='PickARoo' handleChangeDate={handleChangeDate} selectedDate={selectedDate} handleOpenGenInvoice={handleOpenGenInvoice} />  
        </Grid>
        <Grid item xs={12}
          sx={{
              paddingTop: '10px',
