...
const AgileMerchandise = () => {
  ...
  useEffect(() => {
    ...
    fetchAgileMerchandise(anaylticsParam);
    fetchAgileMerchandisePortal(anaylticsParam);
    fetchAgileMerchandiseMatch(anaylticsParam);
    fetchAgileMerchandiseException(exceptionParam);
  }, [fetchAgileMerchandise, fetchAgileMerchandisePortal, fetchAgileMerchandiseMatch, fetchAgileMerchandiseException, page, itemsPerPage, searchQuery, columnToSort, orderBy]);
